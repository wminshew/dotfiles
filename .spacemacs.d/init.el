...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     helm
     (javascript
      :variables javascript-import-tool 'import-js
      :variables javascript-backend 'lsp
      :variables javascript-lsp-linter nil
      :variables javascript-fmt-tool 'prettier
      :variables node-add-modules-path t
      :variables js2-include-node-externs t
      )
     lsp
     markdown
     multiple-cursors
